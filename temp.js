...
var I18N_DICT = {
  ...
  "lbl_requests": { en: "requests", fr: "demandes", zh: "请求" },
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  // Always fetch public company name for the login page
  fetch('/api/public/company')
    ...
    .then(data => {
      if(data && data.name) {
        ...
        if(headerEl)headerEl.textContent=data.name;
      }
    })
    .catch(e => console.log('Could not load company name', e));
});

...
const startIndex = content.indexOf('function buildVNPFHTML(data, forPrint)');
const endIndex = content.indexOf('function getUserHRRecords()');

if (startIndex !== -1 && endIndex !== -1) {
  content = content.substring(0, startIndex) + vnpfHtmlReplacement + content.substring(endIndex);
  fs.writeFileSync('c:/WokManeja/WokManeja/public/index.html', content);
  console.log('Fixed VNPF replacement.');
} else {
